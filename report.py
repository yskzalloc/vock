...
def main():
    ...
    if not source_code_available:
        print(f"{COLOR['YELLOW']}⚠️  [Warning]{COLOR['RESET']} Kernel source directory not found at '{KERNEL_SRC_PATH}'.")
    ...
    for file_path_str, lines in sorted(coverage_by_file.items()):
        ...
        print(f"📄 {COLOR['YELLOW_BOLD']}{file_path_str}{COLOR['RESET']} ({len(lines)} lines covered)")
