/*
 * syscall/x86_64/sys.c — x86_64 syscall number to name mapping.
 * Derived from Linux kernel arch/x86/entry/syscalls/syscall_64.tbl
 * 384 entries (0-335 arch-specific + 424-471 common)
 */
#include "sys.h"
#include <stddef.h>
...
{
	if (nr < 0 || (unsigned long)nr >= SYSCALL_TABLE_SIZE)
		return NULL;
