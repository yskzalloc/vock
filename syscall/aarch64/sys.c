/*
 * syscall/aarch64/sys.c — aarch64 syscall number to name mapping.
 * Uses generic 64-bit numbering (shared with riscv64, loongarch64).
 * 327 entries (0-294 arch-specific + 424-471 common)
 */
#include "sys.h"
#include <stddef.h>
